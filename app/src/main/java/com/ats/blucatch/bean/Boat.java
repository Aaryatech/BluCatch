...
public class Boat {
    ...
    public Boat(long boatId, String boatName, long boatOwner, String regNo, long boatPurchaseDate, int boatLenght, int boatBreadth, int boatHeight, String fishingType, String boatLicNo, long boatLicFromDt, long boatLicToDt, long boatInsuranceFromDt, long boatInsuranceToDt, String boatEngineType, int boatHPRating, int boatIsUsed, long boatTandel, long boatAuctioner, String boatStatus, int blockStatus, int coId, long enterDate, long enterBy) {
        this.boatId = boatId;
    ...
    public Boat(String boatName, long boatOwner, String regNo, long boatPurchaseDate, int boatLenght, int boatBreadth, int boatHeight, String fishingType, String boatLicNo, long boatLicFromDt, long boatLicToDt, long boatInsuranceFromDt, long boatInsuranceToDt, String boatEngineType, int boatHPRating, int boatIsUsed, long boatTandel, long boatAuctioner, String boatStatus, int blockStatus, int coId, long enterDate, long enterBy) {
        this.boatName = boatName;
        this.boatOwner = boatOwner;
        this.regNo = regNo;
        this.boatPurchaseDate = boatPurchaseDate;
